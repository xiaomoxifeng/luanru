...
import com.haoge.luanru.music.util.CommonUtils;
...
public class MusicMainActivity extends SlidingFragment implements
	...
	private final class InnerOnPageChangeListener implements
		...
		public void onPageSelected(int arg0) {
			...
			switch (arg0) {
			case 0:
				System.out.println("onPageSelected______ACTVITY_SET_LOCAL_APP");
				sendBroadcast(new Intent().setAction(ACTVITY_SET_LOCAL_APP));
				onlineMusicFlag = false;
				break;
			case 1:
				System.out.println("onPageSelected______ACTVITY_SET_ONLINE_APP");
	...
	private final class InnerReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (SERVICE_PLAYER_PLAYING.equals(intent.getAction())) {
				...
				currnt.setText(CommonUtils.getTimeString(currentPosition));
				duration.setText(CommonUtils.getTimeString(durationpost));
	...
	private void refresh() {
		...
		if (onlineMusicFlag) {
			...
			albumpic.setImageBitmap(BitmapUtil.loadBitmap(
